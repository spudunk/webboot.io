<div class="container mt-16 tab-content translations-content-item en visible" id="en">
	...
	<ul>
		...
		<li>
			<p>
				<strong>Website</strong> refers to webboot.io, accessible from
				<a href="https://webboot.io" rel="external nofollow noopener" target="_blank"
					>https://webboot.io</a
				>
			</p>
		</li>
	...
	<ul>
		<li>
			<p>By email: <a href="mailto:info@webboot.io">info@webboot.io</a></p>
		</li>
		<li>
			<p>
